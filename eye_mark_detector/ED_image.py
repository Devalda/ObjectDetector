...
if lines:
    ...
    # vertical(v) Horizontal(h) startpoint(s) endpoint(e)
...
# cv.approxPolyDP("longest line contour")
# define point a and b , count pixel
...
eyemark_height = hb  * 100
cutoff = 'if eyemark height is not 100% || hb_set.append(hb) ||  if hb < hb_set[0]'

cutoff , not_center_right , not_center_left = False
if CHB < y2N:
    ...
    cv.imshow("reject", cropped2)
elif not_center_right:
    # zone 2
    print("not center right")
elif not_center_left:
    # zone 1
    print("not center left")
